...
<link href='http://fonts.googleapis.com/css?family=Cabin:regular,bold' rel='stylesheet' type='text/css'>
	...
	<link rel="stylesheet" href="#themePath#/css/cosumnes.css" type="text/css" media="all" />
	...
	<script type="text/javascript" src="#event.getSite().getAssetPath()#/js/jquery/jquery.js"></script>
